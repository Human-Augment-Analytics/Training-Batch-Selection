...
from trainer.constants import (
    ...
    USE_GPU, NUM_WORKERS, PIN_MEMORY
)
...
# Evaluation function - optimized for GPU/CPU auto-switching
def evaluate(model, ds):
    # use larger batch for eval + optimizations for GPU
    loader = DataLoader(ds, batch_size=256, num_workers=NUM_WORKERS, pin_memory=PIN_MEMORY)
    model.eval()
