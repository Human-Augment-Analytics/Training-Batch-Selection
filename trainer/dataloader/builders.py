...
def build_mnist(root, *, as_flat=True, normalize=True, download=False):
...
def build_qmnist(root, *, as_flat=True, normalize=True, download=False):
...
def build_cifar10_flat(root, *, normalize=True, augment=True, download=False):
