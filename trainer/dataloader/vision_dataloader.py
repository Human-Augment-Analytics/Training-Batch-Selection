...
class QMNISTCsvDataset(BaseDataset):
    ...
    def _load_data(self):
        ...
        if not os.path.exists(self.csv_path):
            ...
            # import and run auto-converter
            from trainer.dataloader.auto_convert_csv import ensure_qmnist_csv
            from trainer.constants import DATASETS_ROOT
...
class CIFAR10CsvDataset(BaseDataset):
    ...
    def _load_data(self):
        ...
        if not os.path.exists(self.csv_path):
            ...
            # import and run auto-converter
            from trainer.dataloader.auto_convert_csv import ensure_cifar10_csv
            from trainer.constants import DATASETS_ROOT
...
class CIFAR100CsvDataset(BaseDataset):
    ...
    def _load_data(self):
        ...
        if not os.path.exists(self.csv_path):
            ...
            # import and run auto-converter
            from trainer.dataloader.auto_convert_csv import ensure_cifar100_csv
            from trainer.constants import DATASETS_ROOT
